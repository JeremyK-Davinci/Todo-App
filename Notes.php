            ...
            <?php if($cards != NULL){?>
                <?php foreach($cards as $card){?>
                    ...
                    <?php foreach($taskIds as $task){?>
                        ...
                        ?>
                    <?php }?>
                    <div class="Note col-lg-3 col-sm-6 col-12 d-block mb-5 ml-2 mr-5 border border-light rounded">
                                ...
                                <?php foreach($tasks as $task){?>
                                    <li class="text-light font-weight-bold text-decoration-none text-center list-group-item">
                                        <?php if($task['taskComplete'] == "0"){?>
                                            <p class="font-weight-bold text-info text-decoration-none" data-toggle="tooltip" title="Incomplete"><?= $task['taskName']?></p>
                                        <?php } else {?>
                                            <p class="font-weight-bold text-success text-decoration-none" data-toggle="tooltip" title="Complete"><?= $task['taskName']?></p>
                                        <?php }?>
                                    </li>
                                <?php }?>
                            </ul>
